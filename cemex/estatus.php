...
<title>Estatus - Operadores</title>
    <style>
        body {
...
<div id="container">
  <header>
    ...
    <p>
      ...
      <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Buscar por ID....">
      <input type="date" id="dateFilter" onchange="filterByDate()">
		
    </p>
    <p>
      <a href="ver_datos.php">OPERADORES</a>   
    ...
    <table id="operadoresTable">
      <thead>
        ...
        <tbody>
            ...
            $sql = "SELECT IdEstatus,IdOperador,Fila,Pension FROM estatus";
